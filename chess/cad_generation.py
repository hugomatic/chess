...
from chess.cad_model import CadModel
...
from chess.cad_readme import render_run_readme
from chess.cad_planning import RenderJob, RenderPlan, plan_as_dict
    ...
    try:
        ...
        for render_job, job in zip(plan.jobs, jobs):
            ...
            try:
                ...
                process_env["CHESS_CAD_MANIFEST"] = str(
