...
from chess.cad_system import CadProductItem, CadSystem
from chess.cad_manufacturing import (
    DirectiveSource,
    ManufacturingPolicy,
    merge_manufacturing,
)
from chess.cad_profiles import CadProfile, resolve_profile_ids
from chess.cad_values import ResolvedVariable, parse_raw_defines, resolve_variables
