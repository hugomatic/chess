...
from chess.cad_generation import CadRunExistsError, generate_plan
...
from chess.cli import build_parser, main
...
class CadCliTests(unittest.TestCase):
    def setUp(self):
        ...
        self.context = ProjectContext(self.root, self.data)

    def tearDown(self):
        self.temp.cleanup()

    def env(self):
        return {"CHESS_ROOT": str(self.root), "CHESS_DATA_DIR": str(self.data)}
    ...
    def test_configured_default_system_precedes_noninteractive_ambiguity(self):
        ...
        self.assertIn("chess cad systems", diagnostic["message"])
    ...
    def test_new_interactive_menu_selects_described_template(self):
        ...
        self.assertIn("chess cad sets pump --system alpha", stdout.getvalue())
